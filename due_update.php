...
$msg='suc';
 ...
 //SENDING SMS
            ...
            $message = "Dear ".$send_name." You've Paid ".$paid." Succesfully  to Dr. Abdul with Payment ID ".$last_id['last_id']." and Left the due of ".$due_send." Thanks for Visiting INSHA PHYSIOTHERAPY CENTER";
